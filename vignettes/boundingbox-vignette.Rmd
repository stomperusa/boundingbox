...
*show_classifier*: Logical to include the classifier above the bounding box if outbox is T. Default is FALSE.
...
box_coords <- boxer(names = c("dog1.jpg", "dog2.jpg"), file_path_input = "/dog_pics/input/", 
                    ...
                    show_classifier = TRUE, resize_x = 224, resize_y = 224, outpics = TRUE)
```
...
box_coords <- data.frame(file_name = c("dog1.jpg", "dog2.jpg"), x_left = c(19,41), y_top = c(9,5), x_right = c(201, 149), y_bottom = c(223, 216), size_x = c(224, 224), size_y = c(224,224), classifier = "dog", color = "red", stringsAsFactors = FALSE)
box_coords
```
...
### Example
``` {r, echo = TRUE, eval = FALSE}
dog_df <- data.frame(ref = (1:2), class = c("Skip", "Waltz"), color = c("red","yellow"), stringsAsFactors = FALSE)

box_coords2 <- boxer2(names = c("SW1.png"), file_path_input = "/dog_pics/input/", 
                    file_path_output = "/dog_pics/output/", classifier = dog_df, 
                    show_classifier = TRUE, outbox = TRUE)
```
...
outBox(points_master = box_coords2, file_path_input = "/dog_pics/input/", 
    file_path_output = "/dog_pics/output/", show_classifier = TRUE)
```
